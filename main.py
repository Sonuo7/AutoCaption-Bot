...
app_id = int(os.environ.get("app_id", "24139145"))
api_hash = os.environ.get("api_hash", "726096d9244efd78707cd468ef89d431")
bot_token = os.environ.get("bot_token", "")
custom_caption = os.environ.get("custom_caption", "`{file_name}`\n\n**Powered By - @Alsamovies**") # Here You Can Give Anything, if You Want Real File Name Then Use {file_name}
...
about_message = """
<b>• Name : <a href=https://t.me/Alsamovies>Alsa AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/Alsamovies>[ALSA UPDATES]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/Alsamovies>Click Here</a></b>
<b>• Source Code : <a href=https://github.com/Sonuo7>Click Here</a></b>"""
...
def start_buttons(bot, update):
    bot = bot.get_me()
    buttons = [[
        pyrogram.types.InlineKeyboardButton("Updates", url="t.me/Alsamovies"),
        pyrogram.types.InlineKeyboardButton("About 🤠", callback_data="about")
    ],[
        pyrogram.types.InlineKeyboardButton("➕️ Add To Your Channel ➕️", url=f"http://t.me/Alsa AutoCaption?startchannel=true")
    ]]
...
print("Bot Created By @Alsamovies")
